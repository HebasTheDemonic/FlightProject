...
namespace FlightProjectTest
{
    ...
    public class LoggedInAirlineFacadeTest
    {
        ...
        public void CancelFlight_FlightFound()
        {
            ...
            Assert.ThrowsException<NullResultException>(new Action(() => airlineFacade.CancelFlight(airlineFacade.LoginToken, flightId)));
        }
        ...
        public void CancelFlight_FlightBelongsToAnotherUser_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => airlineFacade.CancelFlight(airlineFacade.LoginToken, flightId)));
        }
