...
namespace FlightProjectTest
{
    ...
    public class LoggedInAdministratorFacadeTest
    {
        ...
        public void CreateNewAdministrator_UserIsRegularAdmin_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => administratorFacade.CreateNewAdministrator(administratorFacade.LoginToken, administrator)));
        }
        ...
        public void RemoveAdministrator_TryingToRemoveHeadAdministrator_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => administratorFacade.RemoveAdministrator(administratorFacade.LoginToken, administrator)));
        }
        ...
        public void UpdateAdministrator_TokenUsernameIsNotAdmin_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => administratorFacade.UpdateAdministrator(administratorFacade.LoginToken, administrator)));
        }
        ...
        public void UpdateAirline_AirlineNotFound()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => administratorFacade.UpdateAirlineDetails(administratorFacade.LoginToken, airlineCompany)));
        }
        ...
        public int UserLogin(string username, string password)
        {
            ...
            flyingCenterSystem.Username = username;
            flyingCenterSystem.Password = password;
            return flyingCenterSystem.UserLogin();
        }
    }
}
