...
namespace FlightProjectTest
{
    ...
    public class LoggedInCustomerFacadeTest
    {
        ...
        public void PurchaseTicket_UserAleradyPurchasedTicket_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => { Ticket ticket = customerFacade.PurchaseTicket(customerFacade.LoginToken, 2); }));
        }
        ...
        public void PurchaseTicket_NoAvailableTicketsOnFlight_ThrowsException()
        {
            ...
            Assert.ThrowsException<UnauthorisedActionException>(new Action(() => { Ticket ticket = customerFacade.PurchaseTicket(customerFacade.LoginToken, 5); }));
        }
